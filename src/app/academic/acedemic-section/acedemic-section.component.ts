...
@Component({
  selector: 'ngx-acedemic-section',
  templateUrl: './acedemic-section.component.html',
  styleUrls: ['./acedemic-section.component.scss'],
})

export class AcademicSectionComponent implements OnInit, OnDestroy {
  private alive = true;
  modules:any[];
